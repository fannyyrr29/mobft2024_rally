    ...
    <script>
        $(document).ready(function() {
            const questions = {
                ...
                'ORTN':{question:'Nama Dosen Koordinator Kemahasiswaan adalah…', a:'Herman Susanto, S.T., M.Sc', b:'Dr. Ir. Susila Candra, M.T., IPM.', c:'Ir. Eric Wibisono, Ph.D., IPU', d:'Argo Hadi Kusumo, M.B.A', ans:'Argo Hadi Kusumo, M.B.A'},
